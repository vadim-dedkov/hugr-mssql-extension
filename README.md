...
> Latest published version **v0.2.1** · **14,021** downloads in the trailing 7 days (snapshot 2026-07-27 UTC). Counts are a Cloudflare estimate of `INSTALL mssql FROM community` events, aggregated across DuckDB versions and platforms. Source: [DuckDB Community Extensions download metrics](https://duckdb.org/community_extensions/download_metrics).
